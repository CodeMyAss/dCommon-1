 ...
 * @author DarkBlade12
 */
public final class FancyApiReflectionHandler {
	private FancyApiReflectionHandler() {}
	...
	public enum PacketType {
		...
		public Class<?> getPacket() throws Exception {
			return packet == null ? packet = FancyApiReflectionHandler.getClass(name, PackageType.MINECRAFT_SERVER) : packet;
		}
	}
}